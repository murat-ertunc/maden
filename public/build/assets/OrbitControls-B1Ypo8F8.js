...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Ya(){return new Ln({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ds(),fragmentShader:`
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function qa(){return new Ln({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ds(),fragmentShader:`
...
`].filter(vi).join(`
`)),o=Es(o),o=no(o,e),o=io(o,e),a=Es(a),a=no(a,e),a=io(a,e),o=ro(o),a=ro(a),e.isWebGL2&&e.isRawShaderMaterial!==!0&&(y=`#version 300 es
