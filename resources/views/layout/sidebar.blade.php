<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item" slug="home">
                <a class="d-flex align-items-center" href="app-email.html">
                    <i data-feather="home"></i>
                    <span class="menu-title text-truncate" data-i18n="home">@lang('general.home')</span>
                </a>
            </li>

            <li class=" navigation-header">
                <span data-i18n="Apps &amp; Pages">@lang('general.modules.appointment')</span>
