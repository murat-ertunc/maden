            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('password.request') }}" class="form-label float-right text-muted"><small>@lang('auth.forgot_password')</small></a>
...
@push('page-styles')
    ...
    <link rel="stylesheet" type="text/css" href="/theme-assets/css/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="/theme-assets/css/pages/page-auth.css">
@endpush

@push('page-scripts')
    <script src="/theme-assets/js/scripts/pages/page-auth-register.js"></script>
